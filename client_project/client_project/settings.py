...
SECRET_KEY = 'django-insecure-k$7(_p_wfidcw3lbr&qglrwc8ld9(+5zqu9nlq0$$btn$s8d!j'
...
AUTH_USER_MODEL = 'client_api.Client'
SITE_ID = 1
...
REST_FRAMEWORK = {
    ...
    # method for collecting user name and password information
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.BasicAuthentication',
    ]
}

# for registration clientregisterserializer
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'client_api.serializers.ClientRegisterSerializer'
}

# For Display all data in serializers
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'client_api.serializers.ClientListSerializer',
}
